...
@Using Html.BeginForm("Create", "ManageTLDHost", FormMethod.Post, New With {.id = "formCreateTLDHost", .onsubmit = "submitForm(); return false;"})
    @<div class="form-horizontal">
        <div class="control-group">
            <div class="control-label">@Html.LabelFor(Function(m) Model.TLD)</div>
            <div class="controls">@Html.TextBoxFor(Function(m) Model.TLD)</div>
        </div>
        <div class="control-group">
