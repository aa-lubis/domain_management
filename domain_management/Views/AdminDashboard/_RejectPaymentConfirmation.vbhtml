...
You are going to reject this payment confirmation back to user. Notification will be sent to user by email<br />
...
@Using Html.BeginForm()
    ...
    End If
        <div class="control-group">
            ...
            <div class="controls">@Html.TextAreaFor(Function(m) Model.PaymentVerificationRemark)</div>
        </div>
    </div>
End Using