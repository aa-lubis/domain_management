        ...
        <div class="row">
            <div class="span10 offset1">
                ...
                <div id="links" style="text-align: center; margin-top: 10px">
                    @Html.ActionLink("Back to Home", "Index", "AdminDashboard")
                    &nbsp;&nbsp;|&nbsp;&nbsp;
                    @If Not Model.Invoice Is Nothing Then
                        @<a href="javascript:window.print()">Print</a> 
                        @:&nbsp;&nbsp;|&nbsp;&nbsp;
                        @<a style="cursor:pointer" href="@Url.Action("Invoice", "AdminDashboard", New With {.i = Model.Invoice.InvoiceID, .export = "pdf"})" target="_blank">Download as PDF</a>
                    End If
                </div>
            </div>
        </div>
